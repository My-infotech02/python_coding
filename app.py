...
if change == 1:
    ...
    for keys, values in length_dict.items():
        print("{:2}. {}".format(keys, values))
    length_convert = int(input("\nWhich conversion you want to do from 1 to 14: "))
    ...
    if length_convert == 1:
        ...
        print("{} cm is equal to {} ft".format(length_value, length_value *0.0328))
    elif length_convert == 12:
        print("{} ft is equal to {} in".format(length_value, length_value * 12))
    elif length_convert == 13:
        print("{} sqft is equal to {} sqm".format(length_value, length_value * 0.0929))
    elif length_convert == 14:
        print("{} sqft is equal to {} acre".format(length_value, length_value / 43560))
    else:
